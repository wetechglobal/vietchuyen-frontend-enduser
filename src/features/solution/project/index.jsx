...
const CardProject = (props) => {
    const { image, miniTitle, contentheader, contentmini, minititlecolor } = props
        ...
        <div className="project-item">
            <div className="card">
                ...
                <div className="background-img-part2">
                    <img className="card-img-part2" src={image} alt="" />
                </div>
                ...
                {contentmini.map((item, idx) =>
                    <Row key={idx} className="header-content-mini">
                        ...
                        <Col className="header-content-link" md={11}>{item.replace("<p>", "").replace("</p>", "")}</Col>
                    </Row>)}
            </div>
        </div>
    )
