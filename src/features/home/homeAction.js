...
// export const changeStatusHomeAction = createAction(HOME.CHANGE_STATUS);
// export const changeStatusHomeSuccessAction = createAction(HOME.CHANGE_STATUS_SUCCESS);
// export const changeStatusHomeFailureAction = createAction(HOME.CHANGE_STATUS_FAILURE);
// export const deleteHomeAction = createAction(HOME.DELETE);
// export const deleteHomeSuccessAction = createAction(HOME.DELETE_SUCCESS);
// export const deleteHomeFailureAction = createAction(HOME.DELETE_FAILURE);
// export const addHomeAction = createAction(HOME.ADD);
// export const addHomeSuccessAction = createAction(HOME.ADD_SUCCESS);
// export const addHomeFailureAction = createAction(HOME.ADD_FAILURE);
// export const editHomeAction = createAction(HOME.EDIT);
// export const editHomeSuccessAction = createAction(HOME.EDIT_SUCCESS);
// export const editHomeFailureAction = createAction(HOME.EDIT_FAILURE);